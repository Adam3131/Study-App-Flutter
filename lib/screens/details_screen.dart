...
import 'package:study_app/constants/color.dart';
...
import 'package:study_app/widgets/custom_video_player.dart';
import 'package:study_app/widgets/lesson_card.dart';
...
class _CustomTabViewState extends State<CustomTabView> {
  final List<String> _tags = ["Playlist (1)", "Description"];
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.index != index ? null : kPrimaryColor,
